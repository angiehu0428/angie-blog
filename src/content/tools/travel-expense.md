...
icon: ✈️
tag: AI · 記帳
desc: 出國玩很爽、回來對帳很痛——一疊收據、每筆幣別不同、還要回頭查當天匯率。拍收據或刷卡截圖丟進去,AI 自動辨識金額品項、用刷卡當日匯率換算,還會自動去重、交通卡只記加值,免手 key。
features:
...
出國玩的時候花錢很爽,回來對帳很痛:一疊收據、每筆幣別不一樣、還要一筆筆回頭查刷卡當天的匯率,才知道一趟到底花多少、跟朋友怎麼分。市面上的記帳 App 大多要你手動輸入、也不幫你換匯。這工具就是把「拍照 → 辨識 → 換匯 → 去重」整條自動化,讓對帳不用再拖到旅程結束還在算。
